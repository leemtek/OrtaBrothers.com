...
const obHomeHero = () => {
  return (
    <section className="wow fadeIn example no-padding no-transition">
                  ...
                  <ul>{/* slide 1 */}
                      <li data-index="rs-3045" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="200"  data-thumb=""  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="100" data-fsslotamount="0" data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "uppercase", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 600, letterSpacing: "2px" }}>Contra Costa County Carpet Cleaning Services
                                </div>
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                data-type="text" 
                                data-responsive_offset="on" 
                                data-frames='[{"from":"y:50px;opacity:0;","speed":1500,"to":"o:1;","delay":300,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[175%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"},{"frame":"hover","speed":"300","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(255, 255, 255, 1.00);bc:rgba(255, 255, 255, 1.00);bw:2px 2px 2px 2px;"}]'
                                data-textalign="['center','center','center','center']"
                                data-paddingtop="[10,10,10,10]"
                                data-paddingright="[0,0,0,0]"
                                data-paddingbottom="[10,10,10,10]"
                                data-paddingleft="[0,0,0,0]"
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "uppercase", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 300, letterSpacing: "2px" }}>Looking for the best Carpet Cleaning<br />in the East Bay? Get a free no- obligation quote.<br /> If you live in the Concord, Martinez, Walnut Creek,<br /> Antioch or surrounding areas, we’ll be happy<br /> to give you a carpet cleaning quote by phone<br /> or at your home. You’ll love it, we guarantee it!
                                </div>
                          {/* layer nr. 3 */}
                      ...
                      <li data-index="rs-2" data-transition="fade" data-slotamount="2" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                data-paddingbottom="[10,10,10,10]"
                                data-paddingleft="[0,0,0,0]"
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "uppercase", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 600, letterSpacing: "2px" }}>Licensed, Insured, &amp; Bonded
                                </div>
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                data-paddingbottom="[10,10,10,10]"
                                data-paddingleft="[0,0,0,0]"
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "uppercase", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 300, letterSpacing: "2px" }}>Orta Brothers Carpet Cleaning Inc. are carpet<br /> and upholstery cleaning specialist.  Featuring<br /> truck mounted steam cleaning and dry cleaning<br /> systems. We use all 100% biodegradable<br /> cleaning agents that are safe for humans and pets.
                                </div>
                          {/* layer nr. 3 */}
                          <Link to="/services" className="tp-caption btn btn-transparent-white btn-medium border-radius-4 z-index-5" 
                              data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                      ...
                      <li data-index="rs-3" data-transition="fade" data-slotamount="3" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                data-paddingbottom="[10,10,10,10]"
                                data-paddingleft="[0,0,0,0]"
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "uppercase", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 600, letterSpacing: "2px" }}>Our Mission Statement
                                </div>
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                data-paddingbottom="[10,10,10,10]"
                                data-paddingleft="[0,0,0,0]"
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "uppercase", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 300, letterSpacing: "2px" }}>To perform the best quality service and<br /> meet and exceed our customers expectations<br /> at affordable prices.<br /><br /> “see what works best” 
