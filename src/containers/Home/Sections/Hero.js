              ...
              <div id="rev_slider_1078_1" className="rev_slider fullwidthabanner" style={{ display: "none" }} data-version="5.4.1">
                  <ul>
                      ...
                      <li data-index="rs-3045" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="200"  data-thumb=""  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="100" data-fsslotamount="0" data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                          ...
                          {/* main image */}
                          <img src="https://d1xrp9zhb3ks3c.cloudfront.net/web/ortabrothers/images/clean-interior.jpg"  alt="Orta Brothers clean interior"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" className="rev-slidebg" />
                      ...
                      <li data-index="rs-2" data-transition="fade" data-slotamount="3" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                          ...
                          <div className="tp-caption NotGeneric-SubTitle tp-resizeme " 
                                data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                                data-y="['middle','middle','middle','middle']" data-voffset="['-115','-110','-100','-90']" 
                                data-fontsize="['60','52','50','35']"
                                data-lineheight="['65','62','60','48']"
                                data-width="none"
                                data-height="none"
                                ...
                                data-paddingleft="[30,30,30,30]"
                                data-basealign="slide" 
                                style={{ zIndex: "8", whiteSpace: "nowrap", fontFamily: "'Montserrat', sans-serif !important", fontWeight: "600", letterSpacing: "-1px" }}>Try Our Amazing Pet Stain<br /> &amp; Odor Removal</div>
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                data-paddingleft="[30,30,30,30]"
                                data-basealign="slide" 
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "none", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 500, letterSpacing: "2px" }}>Special carpet protectors, pet deodorizers<br />and pet stain treatments</div>
                          ...
                          <Link to="/services" className="tp-caption btn btn-transparent-white btn-medium border-radius-4 z-index-5" 
                              data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                              data-y="['middle','middle','middle','middle']" data-voffset="['100','95','90','80']" 
                              data-fontsize="['17','16','15','14']"
                              data-whitespace="nowrap"
                              data-visibility="['on', 'on', 'on', 'on']"
                              data-type="text"
                      ...
                      <li data-index="rs-3" data-transition="fade" data-slotamount="3" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                          ...
                          {/* main image */}
                          <img src="https://d1xrp9zhb3ks3c.cloudfront.net/web/ortabrothers/images/clean-grout-and-tile.jpg"  alt="Orta Brothers clean grout and tile"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" className="rev-slidebg" data-no-retina />
                          ...
                          <div className="tp-caption NotGeneric-SubTitle tp-resizeme " 
                                ...
                                data-paddingleft="[30,30,30,30]"
                                data-basealign="slide" 
                                style={{ zIndex: "8", whiteSpace: "nowrap", fontFamily: "'Montserrat', sans-serif !important", fontWeight: "600", letterSpacing: "-1px" }}>Our Mission Statement</div>
                          ...
                          <div className="tp-caption NotGeneric-Title tp-resizeme" 
                                ...
                                data-paddingleft="[30,30,30,30]"
                                data-basealign="slide" 
                                style={{ zIndex: "7", whiteSpace: "nowrap", textTransform: "none", fontFamily: "'Montserrat', sans-serif !important", fontWeight: 500, letterSpacing: "2px" }}>To perform the best quality service and meet<br /> and exceed our customers expectations<br /> at affordable prices.<br /><br />
                          ...
                          <Link to="/services" className="tp-caption btn btn-transparent-white btn-medium border-radius-4 z-index-5" 
                              data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                              data-y="['middle','middle','middle','middle']" data-voffset="['130','120','120','110']" 
                              data-fontsize="['17','16','15','14']"
                              data-whitespace="nowrap"
                              data-visibility="['on', 'on', 'on', 'on']"
                              data-type="text"
